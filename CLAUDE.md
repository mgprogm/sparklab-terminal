...
- `apps/terminal/` — Next.js frontend. Auth gate in `src/features/auth/`; terminal logic in `src/features/terminal/`; the Agent Chat UI in `src/features/agent-chat/` (FAB, docked panel, approval card, attribution overlay).
